...
) extends RentalServiceRules[String, UUID, UUID, ZonedDateTime, MutableMapDVDRepository] {

  override def createService = new MutableMapRentalService()

  override def repo = new MutableMapDVDRepository
}
